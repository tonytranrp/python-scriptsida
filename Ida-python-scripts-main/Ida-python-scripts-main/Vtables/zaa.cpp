...
enum class ActorBlockSyncMessage::MessageId : int {
	NONE = 0,
	CREATE = 1,
	DESTROY = 2
	};
...
enum class AnimatePacket::Action : int {
	NoAction = 0,
	Swing = 1,
	WakeUp = 3,
	CriticalHit = 4,
...
enum class CameraPreset::AudioListener : int {
	Camera = 0,
	Player = 1
	};

enum class CameraShakeAction : int {
	Add = 0,
	Stop = 1
	};

enum class CameraShakeType : int {
	Positional = 0,
	Rotational = 1
	};
...
enum class ClientboundDebugRendererPacket::Type : int {
	Invalid = 0,
	ClearDebugMarkers = 1,
	AddDebugMarkerCube = 2
	};

enum class ClientboundMapItemDataPacket::Type : int {
	Invalid = 0,
	TextureUpdate = 1 << 1,
...
enum class CodeBuilderStorageQueryOptions::Category : int {
	None = 0,
	CodeStatus = 1,
	Instantiation = 2
	};

enum class CodeBuilderStorageQueryOptions::Operation : int {
	None = 0,
	Get = 1,
	Set = 2,
	Reset = 3
...
enum class CommandBlockMode : int {
	Normal = 0,
	Repeating = 1,
	Chain = 2
	};
...
enum class ComplexInventoryTransaction::Type : int {
	NormalTransaction = 0,
	InventoryMismatch = 1,
...
enum class Connection::DisconnectFailReason : int {
	Unknown = 0,
...
enum class Editor::WorldType : int {
	NonEditor = 0,
	EditorProject = 1,
	EditorTestLevel = 2
	};

enum class EducationEditionOffer : int {
	None = 0,
	RestOfWorld = 1,
	China_Deprecated = 2
	};

enum class EmotePacket::Flags : int {
	SERVER_SIDE = 1 << 0,
	MUTE_EMOTE_CHAT = 1 << 1
	};

enum class Enchant::Type : int {
	ArmorAll = 0,
	ArmorFire = 1,
	ArmorFall = 2,
	ArmorExplosive = 3,
...
enum class IdentityDefinition::Type : int {
	Invalid = 0,
	Player = 1,
	Entity = 2,
	FakePlayer = 3
...
enum class InteractPacket::Action : int {
	Invalid = 0,
	StopRiding = 3,
	InteractUpdate = 4,
	NpcOpen = 5,
...
enum class InventorySource::InventorySourceFlags : int {
	NoFlag = 0,
	WorldInteraction_Random = 1
	};

enum class InventorySourceType : int {
	InvalidInventory = std::numeric_limits::max(),
...
enum class ItemDescriptor::InternalType : int {
	Invalid = 0,
	Default = 1,
	Molang = 2,
	ItemTag = 3,
...
enum class ItemReleaseInventoryTransaction::ActionType : int {
	Release = 0,
	Use = 1
	};

enum class ItemStackNetResult : int {
	Success = 0,
	Error = 1,
...
enum class ItemStackRequestActionType : int {
	Take = 0,
	Place = 1,
	Swap = 2,
	Drop = 3,
...
enum class ItemUseInventoryTransaction::ActionType : int {
	Place = 0,
	Use = 1,
	Destroy = 2
	};
...
enum class ItemUseOnActorInventoryTransaction::ActionType : int {
	Interact = 0,
	Attack = 1,
	ItemInteract = 2
	};

enum class LabTablePacket::Type : int {
	StartCombine = 0,
	StartReaction = 1,
	Reset = 2
	};

enum class LabTableReactionType : int {
	None = 0,
	IceBomb = 1,
	Bleach = 2,
...
enum class LegacyTelemetryEventPacket::AgentResult : int {
	ActionFail = 0,
	ActionSuccess = 1,
	QueryResultFalse = 2,
	QueryResultTrue = 3
...
enum class LegacyTelemetryEventPacket::Type : int {
	Achievement = 0,
	Interaction = 1,
	PortalCreated = 2,
	PortalUsed = 3,
...
enum class MapDecoration::Type : int {
	MarkerWhite = 0,
	MarkerGreen = 1,
	MarkerRed = 2,
	MarkerBlue = 3,
...
enum class MapItemTrackedActor::Type : int {
	Entity = 0,
	BlockEntity = 1,
	Other = 2,
	COUNT = 3
...
enum class MinecraftEventing::InteractionType : int {
	Breeding = 1,
	Taming = 2,
	Curing = 3,
	Crafted = 4,
...
enum class MinecraftEventing::POIBlockInteractionType : int {
	None = 0,
	Extend = 1,
	Clone = 2,
	Lock = 3,
...
enum class MinecraftEventing::TeleportationCause : int {
	Unknown = 0,
	Projectile = 1,
	ChorusFruit = 2,
	Command = 3,
...
enum class MobEffectPacket::Event : int {
	Invalid = 0,
	Add = 1,
	Update = 2,
	Remove = 3
...
enum class ModalFormCancelReason : int {
	UserClosed = 0,
	UserBusy = 1
	};
...
enum class NpcDialoguePacket::NpcDialogueActionType : int {
	Open = 0,
	Close = 1
	};

enum class NpcRequestPacket::RequestType : int {
	SetActions = 0,
	ExecuteAction = 1,
...
enum class ObjectiveSortOrder : int {
	Ascending = 0,
	Descending = 1
	};
...
enum class PlayerAuthInputPacket::InputData : int {
	Ascend = 0,
	Descend = 1,
	NorthJump = 2,
	JumpDown = 3,
...
enum class PlayerListPacketType : int {
	Add = 0,
	Remove = 1
	};
...
enum class PlayerPositionModeComponent::PositionMode : int {
	Normal = 0,
	Respawn = 1,
	Teleport = 2,
	OnlyHeadRot = 3
...
enum class PlayerRespawnState : int {
	SearchingForSpawn = 0,
	ReadyToSpawn = 1,
	ClientReadyToSpawn = 2
	};

enum class PositionTrackingDBClientRequestPacket::Action : int {
	Query = 0
	};

enum class PositionTrackingDBServerBroadcastPacket::Action : int {
	Update = 0,
	Destroy = 1,
	NotFound = 2
	};

enum class Puv::Legacy::LevelSoundEvent : int {
	ItemUseOn = 0,
	Hit = 1,
	Step = 2,
	Fly = 3,
...
enum class RequestAbilityPacket::Type : int {
	Unset = 0,
	Bool = 1,
	Float = 2
	};

enum class ResourcePackResponse : int {
	Cancel = 1,
	Downloading = 2,
...
enum class ScorePacketType : int {
	Change = 0,
	Remove = 1
	};

enum class ScoreboardIdentityPacketType : int {
	Update = 0,
	Remove = 1
	};

enum class SerializedAbilitiesData::SerializedAbilitiesLayer : int {
	CustomCache = 0,
	Base = 1,
	Spectator = 2,
	Commands = 3,
...
enum class ServerAuthMovementMode : int {
	ClientAuthoritative = 0,
	ServerAuthoritative = 1,
	ServerAuthoritativeWithRewind = 2
	};

enum class SetTitlePacket::TitleType : int {
	Clear = 0,
	Reset = 1,
	Title = 2,
	Subtitle = 3,
...
enum class ShowCreditsPacket::CreditsState : int {
	Start = 0,
	Finished = 1
	};

enum class ShowStoreOfferRedirectType : int {
	MarketplaceOffer = 0,
	DressingRoomOffer = 1,
...
enum class SimpleEventPacket::Subtype : int {
...
enum class Social::GamePublishSetting : int {
	NoMultiPlay = 0,
	InviteOnly = 1,
	FriendsOnly = 2,
	FriendsOfFriends = 3,
...
enum class SoftEnumUpdateType : int {
	Add = 0,
	Remove = 1,
	Replace = 2
	};
...
enum class StructureRedstoneSaveMode : int {
	SavesToMemory = 0,
	SavesToDisk = 1
	};

enum class StructureTemplateRequestOperation : int {
	None = 0,
...
enum class StructureTemplateResponseType : int {
	None = 0,
	Export = 1,
	Query = 2,
	Import = 3
...
enum class SubChunkPacket::HeightMapDataType : int {
	NoData = 0,
	HasData = 1,
	AllTooHigh = 2,
	AllTooLow = 3
...
enum class SubChunkPacket::SubChunkRequestResult : int {
	Undefined = 0,
	Success = 1,
...
enum class persona::AnimatedTextureType : int {
	None = 0,
	Face = 1,
	Body32x32 = 2,
	Body128x128 = 3
...
enum class persona::AnimationExpression : int {
	Linear = 0,
	Blinking = 1
	};
